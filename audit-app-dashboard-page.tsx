    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4">
          {[
            { title: "Nouveau Chantier", icon: "🏗️", href: "/dashboard/chantiers/nouveau", color: "from-blue-500 to-blue-600" },
            { title: "Créer Devis", icon: "💰", href: "/dashboard/devis/nouveau", color: "from-green-500 to-green-600" },
            { title: "Messages", icon: "💬", href: "/dashboard/messages", color: "from-purple-500 to-purple-600" },
            { title: "Planning", icon: "📅", href: "/dashboard/planning", color: "from-orange-500 to-orange-600" },
            { title: "Documents", icon: "📁", href: "/dashboard/documents", color: "from-pink-500 to-pink-600" },
            { title: "Équipes", icon: "👥", href: "/dashboard/users", color: "from-indigo-500 to-indigo-600" }
          ].map((action, index) => (
            <Link
              key={index}
              href={action.href}
